        ...
        <form action="examServlet" method="post">
            ...
            <c:choose>
                ...
                <c:when test="${choice==1}">
                    ...
                    <input type="hidden" name="name" value="<%= name %>">
                    <input type="hidden" name="email" value="<%= email %>">
                    <button type="submit" name="op"  value="1">Xóa tài khoản</button><br>
                            ...
                            <table>
                                ...
                                <c:forEach var="u" items="${user}">
                                    <tr>
                                        ...
                                        <td>${u.getDe()}</td>
                                        <td>
                                            <!-- Đường link để truy xuất bài làm của người dùng -->
                                            <a href="viewSubmission.jsp?examId=${u.getDe()}&userName=${u.getName()}">View Submission</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
